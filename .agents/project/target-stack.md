...
Everything here drives the architecture and milestone choices in `CLAUDE.md`. Kept verbatim
so nothing gets lost in translation between the two source listings. Read this when the
question is "why this tech, not X" — day-to-day milestone work doesn't need it loaded.
